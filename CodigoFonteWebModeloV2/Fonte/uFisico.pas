...
uses
  ...
  ActnCtrls, ActnMenus, StdCtrls, FisicoMng, MER, uAux, Contnrs;//, BiLista;
...
procedure TbrFmFisico.acEditarExecute(Sender: TObject);
begin
  if Mng.Selecionado <> nil then ItemDblClick(Mng.Selecionado);
end;
...
begin
  ...
  begin
    ...
    res := StringReplace(res, '*$tipo_campo', GetConvert(fisicoTIPOS, C.Tipo), [rfReplaceAll]);
