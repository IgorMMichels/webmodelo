...
procedure TbrFmShowFisico.btnFecharClick(Sender: TObject);
begin
  close;
end;
...
begin
  ...
  Except
    Result := false;
    Application.MessageBox('Erro ao salvar o arquivo', 'Falha ao salvar', MB_OK or MB_ICONERROR);
  end;
  DDL.PlainText := false;
end;

procedure TbrFmShowFisico.scClick(Sender: TObject);
begin
  SalvarModelo;
end;
